...
> Snapshot notice: this is the point-in-time Prompt 03 verification record from
> 2026-07-16. It is not consumed by the site and is not an authoritative metadata
> source; current fields live only in `papers.yml`.
...
| 10 | [Fantastic Pretraining Optimizers and Where to Find Them](https://openreview.net/forum?id=2J51qUZ0iG) | Published, ICLR 2026; arXiv:2509.02046v2 | [Marin optimizer snapshot](https://github.com/marin-community/marin/tree/f464fee2b6b88c04f47c32d5d2b386759fe993f3/experiments/optimizer_sweep) |
...
- Paper 15 reports per-step runtime and peak memory on eight H100 GPUs, but not aggregate training
  FLOPs or accelerator-hours; the recorded compute budget preserves that boundary.
